...
extern void* syscall4(usize syscall_number, void* arg1, void* arg2, void* arg3,
                      void* arg4);
extern void* syscall5(usize syscall_number, void* arg1, void* arg2, void* arg3,
                      void* arg4, void* arg5);
...
UNIMPLEMENTED sys_sendto(i32 fd, void* buff, usize len, u32 flags, struct SockAddr* addr,
                         i32 addr_len);
...
UNIMPLEMENTED sys_clone(u64 clone_flags, u64 newsp, i32* parent_tidptr, i32* child_tidptr,
                        i32 tls_val);
...
UNIMPLEMENTED sys_wait4(Pid upid, i32* stat_addr, i32 options, struct RUsage* ru);
...
UNIMPLEMENTED sys_sched_setscheduler(Pid pid, i32 policy, struct sched_param* param);
...
UNIMPLEMENTED sys_setxattr(const char* pathname, const char* name, const void* value,
                           usize size, i32 flags);
UNIMPLEMENTED sys_lsetxattr(const char* pathname, const char* name, const void* value,
                            usize size, i32 flags);
UNIMPLEMENTED sys_fsetxattr(i32 fd, const char* name, const void* value, usize size,
                            i32 flags);
...
UNIMPLEMENTED sys_futex(u32* uaddr, i32 op, u32 val, struct TimeSpec* utime, u32* uaddr2,
                        u32 val3);
...
UNIMPLEMENTED sys_io_getevents(AioContext ctx_id, long min_nr, long nr,
                               struct IoEvent* events, struct TimeSpec* timeout);
...
UNIMPLEMENTED sys_timer_create(const ClockId which_clock,
...
UNIMPLEMENTED sys_mq_getsetattr(MsgQueueDescriptor mqdes, const struct mq_attr* u_mqstat,
                                struct mq_attr* u_omqstat);
UNIMPLEMENTED sys_kexec_load(u64 entry, u64 nr_segments, struct kexec_segment* segments,
                             u64 flags);
UNIMPLEMENTED sys_waitid(i32 which, Pid upid, struct siginfo* infop, i32 options,
                         struct rusage* ru);
UNIMPLEMENTED sys_add_key(const char* _type, const char* _description,
                          const void* _payload, usize plen, key_serial_t ringid);
...
UNIMPLEMENTED sys_newfstatat(i32 dfd, const char* filename, struct Stat* statbuf,
                             i32 flag);
...
UNIMPLEMENTED sys_renameat(i32 olddfd, const char* oldname, i32 newdfd,
                           const char* newname);
UNIMPLEMENTED sys_linkat(i32 olddfd, const char* oldname, i32 newdfd, const char* newname,
                         i32 flags);
...
UNIMPLEMENTED sys_move_pages(Pid pid, u64 nr_pages, const void** pages, const i32* nodes,
                             i32* status, i32 flags);
UNIMPLEMENTED sys_utimensat(i32 dfd, const char* filename, struct TimeSpec* utimes,
                            i32 flags);
UNIMPLEMENTED sys_epoll_pwait(i32 epfd, struct EpollEvent* events, i32 maxevents,
                              i32 timeout, const SigSet* sigmask, usize sigsetsize);
...
UNIMPLEMENTED sys_timerfd_settime(i32 ufd, i32 flags, const struct ITimerSpec* utmr,
                                  struct ITimerSpec* otmr);
UNIMPLEMENTED sys_timerfd_gettime(i32 ufd, struct ITimerSpec* otmr);
UNIMPLEMENTED sys_accept4(i32 fd, struct SockAddr* upeer_sockaddr, i32* upeer_addrlen,
                          i32 flags);
...
UNIMPLEMENTED sys_perf_event_open(struct perf_event_attr* attr_uptr, Pid pid, i32 cpu,
                                  i32 group_fd, u64 flags);
...
UNIMPLEMENTED sys_fanotify_mark(i32 fanotify_fd, u32 flags, u64 mask, i32 dfd,
                                const char* pathname);
UNIMPLEMENTED sys_prlimit64(Pid pid, u32 resource, const struct rlimit64* new_rlim,
                            struct rlimit64* old_rlim);
UNIMPLEMENTED sys_name_to_handle_at(i32 dfd, const char* name, struct file_handle* handle,
                                    i32* mnt_id, i32 flag);
...
UNIMPLEMENTED sys_process_vm_readv(Pid pid, const struct IoVec* lvec, u64 liovcnt,
                                   const struct IoVec* rvec, u64 riovcnt, u64 flags);
UNIMPLEMENTED sys_process_vm_writev(Pid pid, const struct IoVec* lvec, u64 liovcnt,
                                    const struct IoVec* rvec, u64 riovcnt, u64 flags);
